...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 26 2023 г., 04:37
...
INSERT INTO `group_user` (`students_group_id`, `user_id`) VALUES
(4, 37),
(8, 38),
(7, 39),
(1, 40),
...
INSERT INTO `mark_detail` (`id`, `selected_answer_variant_id`, `mark_id`) VALUES
(1, 1, 1),
(2, 6, 1),
(3, 1, 2),
(4, 7, 3),
...
(3, 1, '1+1', 2),
(4, 1, '1-1', 2),
(5, 1, 'translate \"data base\"', 3),
(6, 1, 'translate \"valuation\"', 3),
(7, 1, 'translate \"баг\"', 3),
(8, 1, '30*5', 4),
(9, 1, '4*4', 4),
(10, 1, '10*10', 4),
(11, 1, '12*10', 4),
(12, 1, 'some question', 5),
(13, 1, 'another question', 5),
(14, 1, 'another question 2', 5),
(15, 1, 'another question 3', 5),
(16, 1, '1+1', 6),
(17, 1, '2+2+2', 6),
(18, 1, '3*3', 6);
...
INSERT INTO `students_group` (`id`, `name`) VALUES
(1, 'ipz'),
(2, 'kn'),
(4, 'ipz-11'),
(5, 'kn-12'),
...
INSERT INTO `test` (`id`, `duration`, `end_time`, `name`, `number_of_retries`, `author_id`, `students_group_id`) VALUES
(1, 15, '2024-02-26 01:32:00', 'math', 10, 1, 1),
...
(2, '2023-12-26 03:17:48', b'0', 2),
(3, '2023-12-26 04:06:59', b'0', 3),
(4, '2023-12-26 04:19:16', b'0', 4),
...
INSERT INTO `user` (`id`, `email`, `name`, `role`, `test_session_info_id`) VALUES
(1, 'arderchinsky@gmail.com', 'admin', 'ADMIN', NULL),
(37, 'john@pnu.edu.ua', 'John Black', 'STUDENT', 2),
(38, 'vasya@pnu.edu.ua', 'Vasya Pupkovich', 'STUDENT', 3),
(39, 'dick@pnu.edu.ua', 'Richard Snow', 'STUDENT', 4),
(40, 'andry@pnu.edu.ua', 'Andry Bondar', 'STUDENT', 5),
(41, 'yurii.romaniv.22@pnu.edu.ua', 'Bob Smith', 'TEACHER', 6),
(42, 'elena@pnu.edu.ua', 'Elena White', 'TEACHER', 7),
(43, 'stepan@pnu.edu.ua', 'Stepan Potter', 'TEACHER', 8);
...
--
ALTER TABLE `mark_detail`
  ADD CONSTRAINT `FK2lmayymlf0kjk9ebubhwwbxod` FOREIGN KEY (`selected_answer_variant_id`) REFERENCES `answer_variant` (`id`),
